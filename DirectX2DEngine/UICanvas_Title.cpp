...
UICanvas_Title::UICanvas_Title()
	...
	TEST_connectionButton(CreateUIElement<UIButton>(FRect(250.f, -200.f, 150.f, 75.f), DirectX::XMFLOAT4(0.75f, 0.75f, 0.75f, 1.f), DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.f), DirectX::XMFLOAT4(1.f, 1.f, 1.f, 1.f))),
	TEST_connectionButtonTitle(CreateUIElement<UIText>(FRect(250.f, -200.f, 150.f, 75.f), L"Test Connection", L"Cambria", 25.f, D2D1::ColorF(D2D1::ColorF::Black)))

{
	...
	TEST_connectionButton->SetTask([&]
		{
			NETWORK.ConnectTo("127.0.0.1", 1234);
		});
}
